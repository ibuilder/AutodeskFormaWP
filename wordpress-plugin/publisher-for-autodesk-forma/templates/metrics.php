...
if ( empty( $forma_publisher_metrics ) ) {
	?>
	<p class="forma-publisher-empty"><?php esc_html_e( 'No metrics have been published for this project.', 'publisher-for-autodesk-forma' ); ?></p>
	<?php
	return;
}
...
<div class="forma-publisher forma-publisher-metrics forma-publisher-metrics--table">
	<table>
		<caption class="screen-reader-text"><?php esc_html_e( 'Published project metrics', 'publisher-for-autodesk-forma' ); ?></caption>
		<thead>
			<tr>
				<th scope="col"><?php esc_html_e( 'Metric', 'publisher-for-autodesk-forma' ); ?></th>
				<th scope="col"><?php esc_html_e( 'Value', 'publisher-for-autodesk-forma' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php foreach ( $forma_publisher_metrics as $forma_publisher_metric ) : ?>
