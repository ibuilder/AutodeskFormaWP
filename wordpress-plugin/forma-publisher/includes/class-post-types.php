...
class Post_Types {
	...
	public function register_post_types() {
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'               => _x( 'Forma Projects', 'post type general name', 'forma-publisher' ),
					'singular_name'      => _x( 'Forma Project', 'post type singular name', 'forma-publisher' ),
					'menu_name'          => _x( 'Forma Projects', 'admin menu', 'forma-publisher' ),
					'add_new_item'       => __( 'Add New Forma Project', 'forma-publisher' ),
					'edit_item'          => __( 'Edit Forma Project', 'forma-publisher' ),
					'new_item'           => __( 'New Forma Project', 'forma-publisher' ),
					'view_item'          => __( 'View Forma Project', 'forma-publisher' ),
					'search_items'       => __( 'Search Forma Projects', 'forma-publisher' ),
					'not_found'          => __( 'No Forma projects found.', 'forma-publisher' ),
					'not_found_in_trash' => __( 'No Forma projects found in Trash.', 'forma-publisher' ),
					'all_items'          => __( 'All Projects', 'forma-publisher' ),
				),
				'description'         => __( 'Projects published from Autodesk Forma.', 'forma-publisher' ),
				'public'              => true,
				'show_ui'             => true,
				'show_in_menu'        => 'forma-publisher',
				'show_in_rest'        => true,
		...
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'          => _x( 'Forma Assets', 'post type general name', 'forma-publisher' ),
					'singular_name' => _x( 'Forma Asset', 'post type singular name', 'forma-publisher' ),
					'menu_name'     => _x( 'Forma Assets', 'admin menu', 'forma-publisher' ),
					'edit_item'     => __( 'Edit Forma Asset', 'forma-publisher' ),
					'search_items'  => __( 'Search Forma Assets', 'forma-publisher' ),
					'not_found'     => __( 'No Forma assets found.', 'forma-publisher' ),
					'all_items'     => __( 'All Assets', 'forma-publisher' ),
				),
				'description'         => __( 'Files and images published from Autodesk Forma.', 'forma-publisher' ),
				'public'              => false,
				'show_ui'             => true,
				'show_in_menu'        => 'forma-publisher',
				'show_in_rest'        => true,
		...
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'          => _x( 'Forma Publish Log', 'post type general name', 'forma-publisher' ),
					'singular_name' => _x( 'Forma Publish Log Entry', 'post type singular name', 'forma-publisher' ),
				),
				'description'         => __( 'Audit trail of inbound publish operations.', 'forma-publisher' ),
				'public'              => false,
				'show_ui'             => false,
				'show_in_menu'        => false,
				'show_in_rest'        => false,
